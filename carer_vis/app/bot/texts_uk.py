...
T = {
    ...
    "status.alert_nurse": "🚨 Попередження: стан пацієнта {name} містить ризикові ознаки:\n⚠️ '{match}'",
    "message.unknown": "отримано:\n<b>{received_message}</b>\n🤷🏼‍♂️не розумію що це.\nЯкщо тиск то має бути, наприклад:\nпапа 120 60 55",
}
